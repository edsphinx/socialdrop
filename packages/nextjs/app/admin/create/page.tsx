...
const AdminPage = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4 text-center">Panel de Admin</h1>
      <h1 className="text-xl font-bold mb-4 text-center">Crear Campaña</h1>
      <div className="flex flex-col gap-4 w-full max-w-md">
        ...
        />
        <button className="btn btn-primary mt-4" onClick={handleCreateCampaign} disabled={isLoading}>
